...
If you would like to _kindly_ reeducate me, I'd gladly accept input.
...
****
If you're using the `seedwing-policy-server` to serve your types, and this was created in a file called `email.dogma` at the root of your policy directory, you have also created 3 URL endpoints:
